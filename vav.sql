...
--
-- Name: mesa_cambiar_estado(bigint, bigint); Type: FUNCTION; Schema: public; Owner: postgres
--
...
--
-- Name: movil_mesa_nueva(bigint, character varying, bigint, character varying, character varying, character varying, character varying); Type: FUNCTION; Schema: public; Owner: postgres
--

CREATE FUNCTION movil_mesa_nueva(in_usuario_id bigint, in_mesa_tipo character varying, in_mesa_zona bigint, in_mesa_zona_titulo character varying, in_mesa_comuna character varying, in_mesa_local character varying, in_mesa_numero character varying) RETURNS bigint
    LANGUAGE plpgsql
    AS $$
		DECLARE
			in_mesa_id bigint;
...
--
-- Name: swich_consolidados_presidenciales_totales(); Type: FUNCTION; Schema: public; Owner: postgres
--
...
ALTER FUNCTION public.swich_consolidados_presidenciales_totales() OWNER TO postgres;
...
--
-- Name: swich_mesas(bigint, bigint, bigint, bigint); Type: FUNCTION; Schema: public; Owner: postgres
--
...
ALTER FUNCTION public.swich_mesas(in_mesa_1 bigint, in_mesa_2 bigint, in_mesa_3 bigint, in_mesa_4 bigint) OWNER TO postgres;
...
CREATE FUNCTION swich_obtener_datos(in_swich_id bigint) RETURNS TABLE(swich_mesas smallint, swich_modo smallint, swich_titulo character varying, swich_mesa_1 smallint, swich_mesa_2 smallint, swich_mesa_3 smallint, swich_mesa_4 smallint, swich_votos character varying, swich_cambio timestamp without time zone)
    LANGUAGE plpgsql
    AS $$
...
--
-- Name: swich_titulo(bigint, character varying); Type: FUNCTION; Schema: public; Owner: postgres
--

CREATE FUNCTION swich_titulo(in_swich_id bigint, in_swich_titulo character varying) RETURNS bigint
    LANGUAGE plpgsql
    AS $$
...
ALTER FUNCTION public.swich_titulo(in_swich_id bigint, in_swich_titulo character varying) OWNER TO postgres;
...
CREATE TABLE swich (
    ...
    swich_modo smallint,
    swich_titulo character varying
);
...
INSERT INTO candidato VALUES (41900102, 'P', 1, 19001, 999, 6, 'JEANNETTE JARA ROMAN', 'JEANNETTE JARA ROMAN', '', false, 'None', 'JEANNETTE', 'JARA');
INSERT INTO candidato VALUES (41900105, 'P', 2, 19001, 999, 150, 'JOSE ANTONIO KAST RIST', 'JOSE ANTONIO KAST RIST', '', false, 'None', 'JOSE ANTONIO', 'KAST');
...
INSERT INTO mesa VALUES (2, 1, 'P', 19001, 'SAN PEDRO DE LA PAZ', 'SAN PEDRO DE LA PAZ', 'LICEO TESTING', 'M. 37', 1, 1, 0, 0, 0, '2025-12-13 11:40:11.92552', '2025-12-13 11:38:49.46025', '1765636811');
INSERT INTO mesa VALUES (1, 1, 'P', 19001, 'PROVIDENCIA', 'PROVIDENCIA', 'LICEO TESTING', 'M. 255', 1, 1, 1, 0, 0, '2025-12-13 11:41:29.464324', '2025-12-13 11:38:21.394057', '1765636877');
...
SELECT pg_catalog.setval('mesa_id_seq', 2, true);
...
INSERT INTO swich VALUES (2, 4, 0, 0, 0, 0, '0', '2024-10-25 10:02:53.969109', 0, NULL);
INSERT INTO swich VALUES (1, 4, 0, 0, 1, 2, '0', '2025-12-13 11:45:14.039501', 0, 'TENDENCIA EN MESAS PREDICTORAS - CHV DECIDE CHILE 2030');
...
INSERT INTO voto VALUES (102, 41900102, 2, 100);
INSERT INTO voto VALUES (103, 41900105, 2, 100);
INSERT INTO voto VALUES (100, 41900102, 1, 160);
INSERT INTO voto VALUES (101, 41900105, 1, 200);
...
SELECT pg_catalog.setval('voto_id_seq', 103, true);
