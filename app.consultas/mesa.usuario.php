...
//	Construir SQL
	$QUERY_TOTAL							=	"
	    ...
	    SELECT * FROM mesa_usuario_contar_total( $usuario_id );
...
//	Construir SQL
	$QUERY									=	"
		...
		SELECT * FROM mesa_usuario_listado( $usuario_id , $CCNF_RESULTADOS_PAGINAS , ( $CCNF_RESULTADOS_PAGINAS * $CONF_PAGINA_ACTUAL ) );
