					...
					<header class="titulo-seccion no-border">
						...
						<noscript>
							<div class="opciones">
								...
								<div class="boton activo box-shadow-light bordes-radius tipsy-top" id="opcion-voto-P" title="Presidenciales" onclick="mesa_filtrar('P');">🔴</div>
								<div class="boton activo box-shadow-light bordes-radius tipsy-top" id="opcion-voto-S" title="Senadores" onclick="mesa_filtrar('S');">🔵</div>
								<div class="boton activo box-shadow-light bordes-radius tipsy-top" id="opcion-voto-D" title="Diputados" onclick="mesa_filtrar('D');">🟠</div>
							</div>
						</noscript>
					</header>
				</section>
					...
					<section class="swich-r-cnt cols x2" id="mesas-swich">
						...
						<div class="swich-r-box swich-nav box-shadow">
							...
							<div class="swich-mesas" id="swich-opcion-mesas">
								...
								<div onclick="swichMesas(3);" id="swich-opcion-mesas-3" class="bordes-radius box-shadow-light of tipsy-top" title="<h2>Template 3 Mesas</h2><p>Se mostraran en pantalla 3 Mesas</p>">3</div>
								<div onclick="swichMesas(4);" id="swich-opcion-mesas-4" class="bordes-radius box-shadow-light of tipsy-top" title="<h2>Template 4 Mesas</h2><p>Se mostraran en pantalla 4 Mesas</p>">4</div>
							</div>
